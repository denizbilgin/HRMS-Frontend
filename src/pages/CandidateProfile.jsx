...
export default function CandidateProfile() {
    ...
    useEffect(() => {
        ...
        candidateService.getCvByCandidateId(id).then((result) => setCandidateCv(result.data.data));
    }, [])
    ...
    return (
        <div>
            <Divider horizontal style={{ marginBottom: "30px" }}>
                <div style={{paddingTop:"10px",lineHeight:"0px",fontSize:"20px"}}>PROFİLİNİZ</div>
            </Divider>
            <div className="cv-container">
                <Grid>
                    <Grid.Row style={{alignItems:"center",padding:"0",backgroundColor:"white",borderRadius:"15px"}}>
                        <Grid.Column width={5} style={{paddingRight:"0px",height:"100%",paddingLeft:"0"}}>
                            <div className="cv-left">
                                <div>
                                    <Image className="cv-profile-img" src={candidateCv.candidate?.imgUrl} size='small' style={{width:"150px",height:"150px",marginTop:"20px"}}/>
                                ...
                                <div style={{textAlign:"left",marginLeft:"20px",marginTop:"40px"}}>
                                    <div>
                                        ...
                                        <span style={{color:"#d4d4d4"}}>{candidateCv.candidate?.email}</span>
                                    </div>
                                    <div>
                                        <div className="cv-left-bar-header">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <span style={{color:"#d4d4d4"}}>{candidateCv.candidate?.description == null ? "Açıklama Yok" : candidateCv.candidate.description}</span>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="cv-left-bar-header">
                                        ...
                                        <List style={{marginTop:"0px"}}>
                                            {candidateCv.candidateLinks?.map((link) => (
                                                <List.Item key={link.id} href={link.linkPath} style={{color:"#d4d4d4"}}>
                                                    <List.Icon name='caret right' style={{color:"white"}}/>
                        ...
                        <Grid.Column width={11} style={{paddingLeft:"0px",height:"100%",padding:"0px"}}>
                            <div className="cv-right" style={{backgroundColor:"#fff",padding:"30px"}}>
                                    ...
                                    <div>
                                        <List>
                                            {candidateCv.jobExperiences?.map((experience) => (
                                                <List.Item key={experience.id} style={{marginTop:"35px"}}>
                                                    <Grid>
                                                        <Grid.Row style={{paddingTop:"0px",paddingBottom:"25px"}}>
                                                            <Grid.Column width={6}>
                                                                <div style={{fontSize:"16px"}}>
                                                                    <Icon name="long arrow alternate right"/>  
                                                                    {editDate(experience.startDate)} - 
                                                                    {experience.finishDate == null ? "Hala Devam Ediyor" : editDate(experience.finishDate)}
                                                                </div>
                                                            </Grid.Column>
                                                            <Grid.Column width={5}>
                                                                <div style={{textAlign:"center"}}>
                                                                    ...
                                                                    <span className="cv-right-grey-text">{experience.workplaceName}</span>
                                                                </div>
                                                            </Grid.Column>
                                                            <Grid.Column width={5}>
                                                                <div style={{textAlign:"center"}}>
                                                                    ...
                                                                    <span className="cv-right-grey-text">{experience.position}</span>
                                                                </div>
                                                            </Grid.Column>
                                                        </Grid.Row>
                                                    </Grid>
                                                ...
                                                <Grid  key={school.id}>
                                                    <Grid.Row>
                                                        <Grid.Column width={3}>
                                                            ...
                                                            <span className="cv-right-grey-text" style={{marginLeft:"5px"}}>Okul</span>
                                                            <span style={{fontSize:"16px"}}>{school.schoolName}</span>
                                                        </Grid.Column>
                                                        <Grid.Column width={5}>
                                                            <span className="cv-right-grey-text">Bölüm</span>
                                                            <span style={{fontSize:"16px"}}>{school.department}</span>
                                                        </Grid.Column>
                                                        <Grid.Column width={3} style={{paddingLeft:"0px"}}>
                                                            <span className="cv-right-grey-text">Başlangıç</span>
                                                            {editDate(school.entryDate)}
                                                        </Grid.Column>
                                                        <Grid.Column width={5} style={{paddingLeft:"30px"}}>
                                                            <span className="cv-right-grey-text">Mezuniyet</span>
                                                            {school.graduateDate == null ? "Hala Devam Ediyor" : editDate(school.graduateDate)}
                                                        </Grid.Column>
                                                    </Grid.Row>
                                                </Grid>
                                            ))}
                                ...
                                <Divider style={{marginLeft:"0px"}}/>
                                <div className="skills" style={{marginLeft:"15px",marginBottom:"25px"}}>
                                    <div className="cv-right-header">
                                                ...
                                                {candidateCv.skills?.map((skill) => (
                                                        <Grid.Column key={skill.id}>
                                                            <List.Item>
                                                                ...
                                                                <span style={{fontSize:"16px",marginLeft:"6px"}}>{skill.skillName}</span> 
                                                            </List.Item>
                                                        </Grid.Column>
                                                ))}
                                            </Grid>
                                ...
                                <Divider style={{marginLeft:"0px"}}/>
                                <div className="languages" style={{marginLeft:"15px",marginBottom:"25px"}}>
                                    <div className="cv-right-header">
                                        ...
                                        <List>
                                            <Grid columns={2} style={{marginTop:"20px"}}>
                                                    {candidateCv.languages?.map((language) => (
                                                            <Grid.Column key={language.id} style={{paddingTop:"0px"}}>
                                                                <List.Item>
                                                                    <Icon name="comment alternate"/>
                                                                    <span className="cv-right-grey-text" style={{marginLeft:"5px"}}>Dil</span>
                                                                    <span style={{fontSize:"16px",marginLeft:"6px"}}>{language.languageName}</span>

                                                                    <span className="cv-right-grey-text" style={{marginLeft:"25px"}}>Seviye</span>
                                                                    <span style={{fontSize:"16px",marginLeft:"4px"}}>{language.languageLevel}</span>
                                                                </List.Item>
                                                            </Grid.Column>
                                                    ))}
                                            </Grid>
            ...
            onOpen = {() => setOpen(true)}
            open = {open}
            trigger = {<Button primary fluid style={{marginTop:"50px"}}> Bilgilerinizi Güncellemek İçin Tıklayın </Button>}
            >
                <Modal.Header>
